...
root_dirP = '/mnt/lustre/chengruiqi/Pittsburgh/'
root_dirT = '/mnt/lustre/chengruiqi/tokyoTimeMachine/images/'
if not exists(root_dirP):
    raise FileNotFoundError('root_dir is hardcoded, please adjust to point to Pittsburth dataset')
if not exists(root_dirT):
    raise FileNotFoundError('root_dir is hardcoded, please adjust to point to TokyoTimeMachine dataset')
struct_dirP = join(root_dirP, 'datasets/')
queries_dir = join(root_dirP, 'queries_real')
struct_dirT = '/mnt/lustre/chengruiqi/tokyoTimeMachine/'
...
def get_whole_training_set(onlyDB=False):
    structFileP = join(struct_dirP, 'pitts30k_train.mat')
    structFileT = join(struct_dirT, 'tokyoTM_train.mat')
